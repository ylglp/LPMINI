...
<body>
	...
	<BR>
	<form name="department_del" action="del" method="POST">
		Enter Department Id to delete: <input type="text" name="id" size="10">&nbsp;&nbsp;
		<button type="submit" class="lp_button">Delete</button>
	</form>
	
	<form name="department_edit" action="editform" method="POST">
		Enter Department Id to edit: <input type="text" name="id" size="10">&nbsp;&nbsp;
		<button type="submit" class="lp_button">Edit</button>
	</form>
	
	<form name="department_listbyparent" action="listbyparent" method="POST">
		Enter Parent Dept Id to list: <input type="text" name="parentId" size="10">&nbsp;&nbsp;
		<button type="submit" class="lp_button">Parent</button>
	</form>

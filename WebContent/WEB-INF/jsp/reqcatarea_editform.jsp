...
<title>Edit Request Category Area</title>
...
function checkinput() {
	...
	<H2>Edit Request Category Area: ${reqCatArea.id}</H2><BR>
	
	<form:form name="reqcatarea" modelAttribute="reqCatArea" action="edit" method="post" onsubmit="return checkinput();" >
		<form:hidden path="id" />
